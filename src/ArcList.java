...
/**
 * Custom class to represent a collection of Arcs and to simplify the execution
 * of
 * operation on collections of arcs. This is a subclass of the LinkedList class,
 * and
...
public class ArcList extends LinkedList<Arc> {
    ...
    /**
     * Create a new arc from the arguments fv and sv, both of type Variable, and add
     * to the
     * list of arcs.
     * 
